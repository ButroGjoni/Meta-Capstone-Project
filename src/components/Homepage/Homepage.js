      ...
      <section className="week-special">
        ...
        <div className="specials-container">
          <div className="specials">
            ...
            <p>After Adrians trip to Albania and his completion of the special training program, we are happy to introduce the Albanian dessert Trilece!</p>
          </div>
          <div className="specials">
            ...
            <p>We are happy to annouce that after Adrians trip to Albania, The Little Lemon has decorated its interior to resemble traditional Albanian culture</p>
          </div>
          <div className="specials">
            ...
            <p>The Little Lemon is open from 9am to 12am, please reserve a table ahead of time we we may accomodate you accordingly. </p>
          </div>
        </div>
      </section>
    </>
